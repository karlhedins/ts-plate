...
The Babel Typescript preset only strips away the TypeScript types in the transpilation chain - type checking needs to be handled by a separate tsc -w process your and/or your IDE (VS Code recommended).
