...
You can think of TypeScript like a linter with super powers - it catches bugs and adds to the developer expeience in a way that a Javascript linter never even could come close to 👩‍🎤. This is simply due to the fact of Javascripts loosly typed nature where everything can be monkey patched and changed on the go.

In TypeScript your coding experience could look like this:

![](https://github.com/Hotell/blogposts/raw/c5087e6911a1c4ab81d20cb95a478f93d4c3f52e/2018-02/private-properties-in-webcomponents/img/toggleable-component-private-symbols-IDE.gif)
*Credit for the gif goes to TypeScript wizard Martin Hochel* [github](https://github.com/Hotell/)

Be patient on your journey learning TypeScript - TS can be everything from simply adding type annotation to your variables and function arguments to using algebraic data types and generics for constructing extremely flexible components/functions that leverage full type safety no matter what contexts you use them in.
...
```
This example comes from Marius Schulz "Advanced Types in TypeScript" egghead.io course. [Course link](https://egghead.io/courses/advanced-static-types-in-typescript) | [Code](https://github.com/mariusschulz/egghead-advanced-typescript/blob/master/10-discriminated-union-types/src/index.ts)
